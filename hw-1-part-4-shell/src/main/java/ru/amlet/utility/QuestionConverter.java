    ...
    public Question convertQuestion(QuestionDto questionDto) {
        ...
        if (StringUtils.isNotEmpty(questionDto.getFirstAnswer())) {
            question.getAnswers().add(
                    new Answer(questionDto.getFirstAnswer(), questionDto.isFirstCorrect()));
            question.getAnswers().add(
                    new Answer(questionDto.getSecondAnswer(), questionDto.isSecondCorrect()));
            question.getAnswers().add(
                    new Answer(questionDto.getThirdAnswer(), questionDto.isThirdCorrect()));
        }
        return question;
    }
