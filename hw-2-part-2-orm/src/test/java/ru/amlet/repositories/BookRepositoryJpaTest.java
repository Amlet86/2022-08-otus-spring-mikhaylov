...
class BookRepositoryJpaTest {
    ...
    void shouldCreateBook() {
        ...
        var actualBook = bookRepository.saveBook(expectedBook);
    ...
    void shouldReturnExpectedBookByName() {
        ...
        var actualBook = bookRepository.getByName(expectedBook.getName());
    ...
    void shouldReturnExpectedBookById() {
        var expectedBook = testEntityManager.find(Book.class, 1L);
        var actualBook = bookRepository.getById(expectedBook.getId()).orElse(null);
        assertEquals(expectedBook, actualBook);
    }
    ...
    void shouldReturnExpectedBooksList() {
        var expectedBook = testEntityManager.find(Book.class, 1L);
        var actualBooksList = bookRepository.getAll();
